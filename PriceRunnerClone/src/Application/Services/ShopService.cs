...
namespace PriceRunner.Application.Services
{
    public interface IShopService
    {
        ...
        Task<ShopDto> CreateAsync(string fullName, string? shopUrl);
        Task<bool> UpdateAsync(int id, string fullName, string? shopUrl);
    ...
    public sealed class ShopService : IShopService
    {
        ...
        public async Task<ShopDto> CreateAsync(string fullName, string? shopUrl)
        {
            const string insertSql = @"
            INSERT INTO shops (full_name, shop_url)
            VALUES (@FullName, @ShopUrl);
        ...
        public async Task<bool> UpdateAsync(int id, string fullName, string? shopUrl)
        {
